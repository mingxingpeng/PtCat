...
#ifndef PTCAT_FILTER_PMEDIAN_HPP
#define PTCAT_FILTER_PMEDIAN_HPP
                    ...
                    for (int row = 0; row < height; row++){
                        ...
                        for (int col = 0; col < width; col++){
                            ...
                            if (sort_real_count > 0){
                                //修改为当前中值，否则保持原值
                                *curr_data = statistics::descriptive::GetMedianElement(sort_data, sort_real_count);
                            }
                            //遍历到下一个数据
                            curr_data++;
                        }
...
#endif //PTCAT_FILTER_PMEDIAN_HPP
