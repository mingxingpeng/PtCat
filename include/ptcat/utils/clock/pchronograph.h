...
namespace ptcat {
    namespace clock {
        ...
        protected:
            std::chrono::microseconds elapsed_time_;//single timing
        ...
        public:
            ...
            llong Stop();//stop time and return timing count, in microseconds
            ...
            /// </summary>
            /// <returns></returns>
            llong MicroElapsedTime() const;
            /// <summary>
            /// get consum time, unit: ms
            /// </summary>
            /// <returns></returns>
            llong MilliElapsedTime() const;

            /// <summary>
            /// get consum time, unit: s
            /// </summary>
            /// <returns></returns>
            llong ElapsedTime() const;
        };
    }
}
